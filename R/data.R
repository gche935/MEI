...
#'   \item{OrgSize}{Numeric, control variable - organization size.}
...
#' \describe{
#'   \item{ID}{Numeric, case ID number.}
#'   \item{x1_G1}{Numeric, Self-ratings of managerial role item 1  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x2_G1}{Numeric, Self-ratings of managerial role item 2  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x3_G1}{Numeric, Self-ratings of managerial role item 3  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x4_G1}{Numeric, Self-ratings of managerial role item 4  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x5_G1}{Numeric, Self-ratings of managerial role item 5  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x6_G1}{Numeric, Self-ratings of managerial role item 6  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x7_G1}{Numeric, Self-ratings of managerial role item 7  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x8_G1}{Numeric, Self-ratings of managerial role item 8  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x9_G1}{Numeric, Self-ratings of managerial role item 9  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x10_G1}{Numeric, Self-ratings of managerial role item 10  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x1_G2}{Numeric, Supervisor-ratings of managerial role item 1  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x2_G2}{Numeric, Supervisor-ratings of managerial role item 2  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x3_G2}{Numeric, Supervisor-ratings of managerial role item 3  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x4_G2}{Numeric, Supervisor-ratings of managerial role item 4  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x5_G2}{Numeric, Supervisor-ratings of managerial role item 5  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x6_G2}{Numeric, Supervisor-ratings of managerial role item 6  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x7_G2}{Numeric, Supervisor-ratings of managerial role item 7  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x8_G2}{Numeric, Supervisor-ratings of managerial role item 8  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x9_G2}{Numeric, Supervisor-ratings of managerial role item 9  from 1 (not at all effective) to 7 (extremely effective).}
#'   \item{x10_G2}{Numeric, Supervisor-ratings of managerial role item 10  from 1 (not at all effective) to 7 (extremely effective).}
#' }
